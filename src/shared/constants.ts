...
// «Ремонт» здесь без числа: он восстанавливает здоровье целиком, до максимума
// своего танка (у ботов он свой). Чинить наполовину смысла нет — ящик лежит
// на виду, ехать за ним через простреливаемое место, и половина полоски такой
// поездки не окупает.
/** Урон снаряда 25 -> 40. */
